        ...
        <div className="mj-workspace-content">
          ...
          <header className="mj-artifact-header">
            ...
            <div className="mj-artifact-actions">
              ...
              <a className="mj-secondary-button" href={`/run?artifact=${encodeURIComponent(artifact.id)}`}>{copy.openRun}</a>
            </div>
          </header>
...
function CodeAndExport({ artifact, copied, onCopy, copy }: { artifact: LibraryArtifact; copied: boolean; onCopy: (code?: string) => void; copy: ArtifactCopy }) {
  ...
  return (
    <div className="mj-artifact-grid mj-artifact-grid--code">
      ...
      <section className="mj-artifact-panel">
        <div className="mj-panel-heading"><h2>Export</h2><span className="mj-mono-muted">{copy.classified}</span></div>
...
function Notes({ artifact, copy }: { artifact: LibraryArtifact; copy: ArtifactCopy }) {
  return <section className="mj-artifact-panel"><div className="mj-panel-heading"><h2>{copy.notes}</h2><span className="mj-mono-muted">{copy.workspace}</span></div><p className="mj-artifact-copy">{copy.openRun}. {artifact.source === "demo" ? copy.demoNote : artifact.source === "public" ? copy.publicNote : copy.runNote}</p></section>;
}
