...
const COPY = {
  en: {
    ...
    sizeIntro: "What the algorithm needs at the size you gave the planner. Studio works these out again here instead of reading them from the link.",
    needs: (names: string) => `Needs ${names}.`,
    buildHeading: "Build a stage here",
    insert: "Insert",
    canvasNote: (instance: string) =>
      `The canvas below builds a small instance (${instance}). The numbers above are for the size in your plan, not for what is on screen.`,
