...
const COPY: Record<PublicLocale, {
  ...
  ja: {
    adding: "追加中…",
    addPrivate: "自分のボールトに追加",
    add: "ボールトに追加",
    close: "閉じる",
    library: "個人ボールト",
    title: "サインインしてワークスペースを開きます。",
    body: "を非公開ボールトへコピーすると、Studioでコードを開いたり、検証済みの実行で続けたりできます。アカウントごとに専用ワークスペースがあります。",
    signIn: "サインインして続ける",
    unavailable: "この環境では認証がまだ設定されていません。アクセスを申請するにはお問い合わせください。",
    contact: "Leona Quantumに連絡 ↗",
    error: "エントリをボールトに追加できませんでした。",
    starBoundary: "公開Atlasのスターはボールトにはコピーされません。非公開コピーは未スターで始まります。",
  },
};
