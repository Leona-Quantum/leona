...
//
// Deliberately NOT gated on LEONA_DEPLOY_ENV (unlike lib/public-demo.ts): this
// flag's whole purpose is to eventually be true in production. It is a plain
// opt-in so the rollout is a config change, not a redeploy of different code.
