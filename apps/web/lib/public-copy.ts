...
export const PRICING_COPY: Record<PublicLocale, {
  ...
  en: {
    ...
    plans: [
      ...
      { name: "Team", price: "Let’s talk", cadence: "for research done with other people", description: "Share a project with someone outside your workspace — read-only, or read-and-edit so they can put work back — with a per-project limit you set.", features: ["Share a project with people outside your workspace", "Up to 4 shared projects per person", "50 agent runs a week", "150 private artifacts", "Browser simulation up to 18 qubits"], action: "Contact us", tone: "quiet" },
    ],
  ...
  ja: {
    ...
    plans: [
      ...
      { name: "Team", price: "ご相談ください", cadence: "他の人と進める研究向け", description: "ワークスペースの外の相手にプロジェクトを共有できます。閲覧のみ、または編集可能（相手から回路を追加できます）を選べ、追加できる件数はプロジェクトごとに指定できます。", features: ["ワークスペース外の相手とプロジェクトを共有", "1人あたり参加できる共有プロジェクトは4件まで", "週50回のエージェント実行", "非公開の回路・実行記録150件", "18量子ビットまでのブラウザ実行"], action: "お問い合わせ", tone: "quiet" },
    ],
