...
export const PRICING_COPY: Record<PublicLocale, {
  ...
  ja: {
    ...
    note: { label: "透明なスタート", title: "プロダクトは稼働中。決済はまだです。", body: "ここに示すのは早期アクセスの想定パッケージです。上限、クレジット、決済は有効化前に確定します。公開Atlasの閲覧や研究の相談にカードは必要ありません。" },
  },
};
...
export const WORKSPACE_LANDING_COPY: Record<PublicLocale, {
  ...
  ja: {
    ...
    body: "Leona Quantumは、ガイド付きのワークフローを保護されたシミュレータ、検証の根拠、Studio編集、個人ボールトにつなぎます。各アカウントは専用ワークスペースから始まり、問い、実行、保存アーティファクトは基本的に非公開です。",
    primary: "ワークスペースを相談する",
    secondary: "Atlasから始める",
    loopLabel: "個人の研究ループ",
    loopTitle: "研究、Studio、ボールト、実行をひとつにつなぐ。",
    loop: [
      ...
      { kicker: "03 / VAULT", title: "記録を残す", body: "コード、実行、検証、エクスポート、出典、リソース、制限を非公開アーティファクトにまとめます。" },
    ],
...
export const PRIVACY_COPY: Record<PublicLocale, {
  ...
  ja: {
    ...
    sections: [
      ...
      { title: "2. 情報の利用目的", paragraphs: ["認証、ワークフローの実行と検証、ボールトアーティファクトの保存と再開、サポート、セキュリティ、障害診断、信頼性と品質の改善に利用します。", "集計または匿名化した運用情報を性能理解と改善に利用することがあります。非公開ワークスペースのアーティファクトを、明示的な公開操作なしに公開Atlasへ掲載することはありません。"] },
      ...
      { title: "4. 公開と非公開の研究", paragraphs: ["公開Atlasのエントリは非公開ボールトと分離されています。ボールトの内容は基本的に非公開です。公開操作を行うと、アーティファクト、コード、根拠が他の人に見える可能性があるため、公開前に内容を確認してください。"] },
...
export const TERMS_COPY: Record<PublicLocale, {
  ...
  ja: {
    title: "利用規約",
    lede: "Leona Quantumの公開サイト、ワークベンチ、ボールト、公開Atlasを利用するためのルールです。",
    updated: "最終更新日: 2026年7月15日",
    noteLabel: "早期アクセスに関する注記:",
    ...
    sections: [
      ...
      { title: "4. 利用者のコンテンツ", paragraphs: ["送信したコンテンツについて、利用者が持つ権利は保持されます。Leona Quantumには、サービスを提供するためにホスト、処理、実行、表示、バックアップ、改善するための限定的な許諾を与えます。非公開ボールトの内容は基本的に公開されません。"] },
