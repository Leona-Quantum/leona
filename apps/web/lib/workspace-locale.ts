...
export const TOURS_COPY: Record<PublicLocale, ToursCopy> = {
  en: {
    ...
    steps: {
      ...
      "build.code": { title: "Code", action: "Open the Code tab." },
      "build.convert": { title: "Convert to Cirq", action: "Choose Cirq here. Studio rewrites the circuit in Cirq." },
      "build.visual": { title: "Visual builder", action: "Open the Visual tab. You can add and move gates by hand." },
  ...
  ja: {
    ...
    steps: {
      ...
      "build.code": { title: "コード", action: "「コード」タブを開いてください。" },
      "build.convert": { title: "Cirqに変換", action: "ここでCirqを選ぶと、Studioが回路をCirqのコードに書き換えます。" },
      "build.visual": { title: "回路図", action: "「回路図」タブを開いてください。ゲートを手で追加したり動かしたりできます。" },
