...
protocol-version authority, see ADR-0024): the same scientific spec, hashed as
...
`vqe_observations` row under the same experiment (see ADR-0025), never a new run or a
