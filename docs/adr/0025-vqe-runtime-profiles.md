# ADR-0025: VQE runtime capability resolution is server-authoritative, with frozen and current version lanes
...
gates (ADR-0026) under human/owner review; promotion is a reviewed configuration
...
explicitly out of MVP scope and would each need their own profile and ADR-0025-level
