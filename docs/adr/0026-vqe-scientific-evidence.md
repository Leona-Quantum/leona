# ADR-0026: VQE observations are append-only evidence keyed to a canonical, digested Hamiltonian

**Date:** 2026-07-24 · **Status:** accepted for Phase 4.5 persistence; cardinality clarified by ADR-0031
...
new `ArtifactVersion` (ADR-0024), never a mutation of an existing one. The MVP golden
