# ADR-0030: VQE scientific specs are constructed from workflow components server-side

**Date:** 2026-07-25 · **Status:** superseded by portable schema v0.2 in ADR-0031
...
The same API used the standard HTTP `Idempotency-Key` header, while ADR-0024
