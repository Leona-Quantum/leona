# ADR-0031: VQE portable scientific identity is separate from registry resolution and execution

**Date:** 2026-07-25 · **Status:** accepted for Phase 4.5 implementation

## Context

ADR-0024 and ADR-0030 v0.1 embedded `ArtifactVersion` UUIDs in the
...
6. Component review is represented by independent
   ...
   ADR-0027.  Only an executable registry component promoted for experiment
...
- Persistence requires two digests and one additional table, and public
  ...
  real human review and runtime profiles are promoted under ADR-0025.
...
- ADR-0032 permits non-public Phase 5A integration while human review and
