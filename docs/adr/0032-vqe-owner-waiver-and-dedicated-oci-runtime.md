# ADR-0032: Owner waiver does not equal scientific review; private VQE uses a dedicated OCI runtime

**Date:** 2026-07-26 · **Status:** accepted by owner

## Context

ADR-0031 separated Phase 5A product integration from Phase 5B qualification
