...
| DATABASE_URL_DIRECT | approved migration environment only; not API/Worker/Vercel | Alembic — Neon direct URL; never a runtime application secret | pending owner setup |
