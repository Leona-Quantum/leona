...
| S3 | Pipeline view | rail component + fixtures shipped; event-stream wiring pending |
| S4 | Result panel | verdict banner shipped; panel assembly (numbers → code → baseline → export → Library link) pending |
