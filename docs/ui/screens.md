...
| S4 | Result panel | assembled — verdict → key numbers → code → baseline → export → Vault link, in spec §3 order; failed runs preserve and label the best available deliverable without implying verification |
