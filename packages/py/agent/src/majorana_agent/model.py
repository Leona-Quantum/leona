...
_TOOLS_BY_STATE: dict[AgentState, tuple[ToolName, ...]] = {
    ...
    AgentState.EXECUTED: (ToolName.REVIEW_CANDIDATE,),
    AgentState.REVIEWED: (ToolName.REVIEW_CANDIDATE, ToolName.STRICT_VERIFY),
    AgentState.READY_FOR_STRICT_VERIFICATION: (ToolName.STRICT_VERIFY,),
