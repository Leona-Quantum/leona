...
- **OpenQASM is the verification boundary.** Programs are parsed with Qiskit's official
  importers, while `Operator`/`Statevector` provide an independent execution path.
